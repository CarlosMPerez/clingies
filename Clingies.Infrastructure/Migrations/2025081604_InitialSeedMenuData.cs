...
public class _2025081604_InitialSeedMenuData : Migration
{
    public override void Up()
    {
        ...
        sql = SqlBuilder.BuildInsertSystemTrayIcon("new",
            "avares://Clingies.Avalonia/Assets/menu_light/menu_new.png",
            "avares://Clingies.Avalonia/Assets/menu_dark/menu_new.png");
        Execute.Sql(sql);
        // NEW STACK
        ...
        sql = SqlBuilder.BuildInsertSystemTrayIcon("rolled_up",
            "avares://Clingies.Avalonia/Assets/menu_light/menu_rollup.png",
            "avares://Clingies.Avalonia/Assets/menu_dark/menu_rollup.png");
        Execute.Sql(sql);
        ...
        sql = SqlBuilder.BuildInsertSystemTrayIcon("rolled_down",
            "avares://Clingies.Avalonia/Assets/menu_light/menu_rolldown.png",
            "avares://Clingies.Avalonia/Assets/menu_dark/menu_rolldown.png");
        Execute.Sql(sql);
        // SET ALL __> PINNED
        ...
        sql = SqlBuilder.BuildInsertSystemTrayIcon("pinned",
            "avares://Clingies.Avalonia/Assets/menu_light/menu_pinned.png",
            "avares://Clingies.Avalonia/Assets/menu_dark/menu_pinned.png");
        Execute.Sql(sql);
        // SET ALL __> UNPINNED
        ...
        sql = SqlBuilder.BuildInsertSystemTrayIcon("unpinned",
            "avares://Clingies.Avalonia/Assets/menu_light/menu_unpinned.png",
            "avares://Clingies.Avalonia/Assets/menu_dark/menu_unpinned.png");
        Execute.Sql(sql);
        // SET ALL __> LOCK
        ...
        sql = SqlBuilder.BuildInsertSystemTrayIcon("show",
            "avares://Clingies.Avalonia/Assets/menu_light/menu_show.png",
            "avares://Clingies.Avalonia/Assets/menu_dark/menu_show.png");
        Execute.Sql(sql);
        // SET ALL _> INVISIBLE
        ...
        sql = SqlBuilder.BuildInsertSystemTrayIcon("hide",
            "avares://Clingies.Avalonia/Assets/menu_light/menu_hide.png",
            "avares://Clingies.Avalonia/Assets/menu_dark/menu_hide.png");
        Execute.Sql(sql);
        // SEPARATOR
        ...
        sql = SqlBuilder.BuildInsertSystemTrayIcon("manage_clingies",
            "avares://Clingies.Avalonia/Assets/menu_light/menu_manage.png",
            "avares://Clingies.Avalonia/Assets/menu_dark/menu_manage.png");
        Execute.Sql(sql);
        // SETTINGS
        ...
        sql = SqlBuilder.BuildInsertSystemTrayIcon("help",
            "avares://Clingies.Avalonia/Assets/menu_light/menu_help.png",
            "avares://Clingies.Avalonia/Assets/menu_dark/menu_help.png");
        Execute.Sql(sql);
        // ABOUT
        ...
        sql = SqlBuilder.BuildInsertSystemTrayIcon("about",
            "avares://Clingies.Avalonia/Assets/menu_light/menu_info.png",
            "avares://Clingies.Avalonia/Assets/menu_dark/menu_info.png");
        Execute.Sql(sql);
        // SEPARATOR
        ...
        sql = SqlBuilder.BuildInsertSystemTrayIcon("exit",
            "avares://Clingies.Avalonia/Assets/menu_light/menu_exit.png",
            "avares://Clingies.Avalonia/Assets/menu_dark/menu_exit.png");
        Execute.Sql(sql);
        ...
        sql = SqlBuilder.BuildInsertSystemTrayIcon("clingy_close",
            "avares://Clingies.Avalonia/Assets/clingy_close.png",
            "avares://Clingies.Avalonia/Assets/clingy_close.png");
        Execute.Sql(sql);
        sql = SqlBuilder.BuildInsertSystemTrayIcon("clingy_pinned",
            "avares://Clingies.Avalonia/Assets/clingy_pinned.png",
            "avares://Clingies.Avalonia/Assets/clingy_pinned.png");
        Execute.Sql(sql);
        sql = SqlBuilder.BuildInsertSystemTrayIcon("clingy_unpinned",
            "avares://Clingies.Avalonia/Assets/clingy_unpinned.png",
            "avares://Clingies.Avalonia/Assets/clingy_unpinned.png");
        Execute.Sql(sql);
        sql = SqlBuilder.BuildInsertSystemTrayIcon("clingy_icon",
            "avares://Clingies.Avalonia/Assets/clingy_icon_light.png",
            "avares://Clingies.Avalonia/Assets/clingy_icon_dark.png");
        Execute.Sql(sql);
    }
