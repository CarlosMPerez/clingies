...
public class _2025081603_SeedClingyMenu : Migration
{
    public override void Up()
    {
        ...
        sql = SqlBuilder.BuildInsertSystemTrayIcon("sleep",
            "avares://Clingies/Assets/menu_light/menu_sleep.png",
            "avares://Clingies/Assets/menu_dark/menu_sleep.png");
        Execute.Sql(sql);
        // Attach
        ...
        sql = SqlBuilder.BuildInsertSystemTrayIcon("attach",
            "avares://Clingies/Assets/menu_light/menu_attach.png",
            "avares://Clingies/Assets/menu_dark/menu_attach.png");
        Execute.Sql(sql);
        // Add to Stack
        ...
        sql = SqlBuilder.BuildInsertSystemTrayIcon("alarm",
            "avares://Clingies/Assets/menu_light/menu_alarm.png",
            "avares://Clingies/Assets/menu_dark/menu_alarm.png");
        Execute.Sql(sql);
        // Set title
        ...
        sql = SqlBuilder.BuildInsertSystemTrayIcon("title",
            "avares://Clingies/Assets/menu_light/menu_title.png",
            "avares://Clingies/Assets/menu_dark/menu_title.png");
        Execute.Sql(sql);
        // Set color
        ...
        sql = SqlBuilder.BuildInsertSystemTrayIcon("color",
            "avares://Clingies/Assets/menu_light/menu_change_color.png",
            "avares://Clingies/Assets/menu_dark/menu_change_color.png");
        Execute.Sql(sql);
        // Lock Content
